		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#defcomppaymentui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"defcomppaymentui-display": {
								"semanticObject": "defcomppaymentui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=defcomp.payment.ui",
									"url": sap.ui.require.toUrl("defcomp/payment/ui")
								}
							}
						}
					}
